...
sense = SenseHat()
sense.show_message("ver2CleanUp")
sense.clear()
...
def setRandomOrientation():
    #of the 4 different orientation the program uses this will select one random one 
...
def angleFromStickDirection(stickDirection):
    #this takes the stick direction as an argument and returns the degrees value to what the equivalent would be when roating the board
